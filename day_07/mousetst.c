...
_setvideomode(_VRES16COLOR); //  640x480 in 16 colors, use microsofts stuff
...
// exit main loop when user hits a key
...
while(!kbhit())
     ...
     _settextposition(40,0);

     printf("V I D E O  E A S E L - Press any key to exit.");
